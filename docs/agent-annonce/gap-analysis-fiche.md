...
| Vue (mer/lac/montagne/dégagée…) | ✅ | `section_avis.vue_types[]` | PR #35. 16 types atomiques + « aucune vue » (`vue_piscine` ajoutée après coup). La case legacy `atouts_logement.vue_panoramique` existe encore dans l'état mais n'est plus rendue. |
