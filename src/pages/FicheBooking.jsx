...
export default function FicheBooking() {
  ...
  const annonceActive = formData.annonce_active
  const identifiantsObtenus = formData.identifiants_obtenus
  const urlAnnonce = getField('section_booking.url_annonce')
  const emailCompte = getField('section_booking.email_compte')
  const motPasse = getField('section_booking.mot_passe')
  const explicationRefus = getField('section_booking.explication_refus')
        ...
        <div className="flex-1 p-6 bg-gray-100">
          ...
          <div className="mb-6">
            <label className="block font-semibold mb-3">
              Le propriétaire a-t-il déjà une annonce active sur Booking ? <span className="text-red-500">*</span>
            </label>
            <div className="flex gap-6">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={() => updateField('section_booking.annonce_active', true)}
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={() => updateField('section_booking.annonce_active', false)}
                  className="w-4 h-4 cursor-pointer"
                />
                <span>Non</span>
              </label>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              value={urlAnnonce}
              onChange={(e) => updateField('section_booking.url_annonce', e.target.value)}
          ...
          <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="flex gap-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={() => updateField('section_booking.identifiants_obtenus', true)}
                    className="w-4 h-4 cursor-pointer"
                  />
                  <span>Oui</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={() => updateField('section_booking.identifiants_obtenus', false)}
                    className="w-4 h-4 cursor-pointer"
                  />
                  <span>Non</span>
                </label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={emailCompte}
                    onChange={(e) => updateField('section_booking.email_compte', e.target.value)}
                    className="w-full p-2 border rounded"
                  />
                </div>
                <div>
            ...
            {identifiantsObtenus === false && (
              <div>
                <label className="block font-semibold mb-1">
                  Code Booking - Veuillez expliquez pourquoi vous n'avez pas obtenu les identifiants <span className="text-red-500">*</span>
                </label>
                <textarea
                  placeholder="Expliquez les raisons..."
                  value={explicationRefus}
                  onChange={(e) => updateField('section_booking.explication_refus', e.target.value)}
                  rows={4}
